...
# selenium으로 현재 페이지의 html 소스를 전부 불러오기
...
soup = BeautifulSoup(src, 'html.parser') # html로 변환해줘!
...
# print(div_list[0]) # 1위 책만 가져와보자.

first_book = div_list[0].find_all('li')
# li 안에 필요한 텍스트가 다 있더라. 2,3,4번째 li의 텍스트를 가져와야 하겠더라.
# print(first_book)
